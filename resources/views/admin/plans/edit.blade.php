...
@section('header', 'Edit Plan: ' . $plan->name)
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="type" required>
                            <option value="patrika" {{ old('type', $plan->type) == 'patrika' ? 'selected' : '' }}>Patrika</option>
                            <option value="advertisement" {{ old('type', $plan->type) == 'advertisement' ? 'selected' : '' }}>Advertisement</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="price" name="price" value="{{ old('price', $plan->price) }}" required>
                    </div>
                </div>
