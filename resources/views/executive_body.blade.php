...
@section('title', 'Jaiswal Jagriti Family | Executive Body')

@section('content')
<style>
.executive-section {
    position: relative;
    background-image: url("{{ asset(\App\Models\Setting::getVal('executive_body_banner', 'assets/images/IMG-20250826-WA0008.jpg')) }}");
...
.executive-section .elementor-background-overlay {
    position: absolute;
    inset: 0;
...
.executive-section .elementor-container {
    position: relative;
    z-index: 2;
}

.executive-section .elementor-heading-title {
    color: #fff;
    text-align: center;
    font-size: 48px;
    font-weight: 700;
...
<div data-elementor-type="wp-page" data-elementor-id="6853" class="elementor elementor-6853" data-elementor-post-type="page">
    <section class="elementor-section elementor-top-section elementor-element elementor-element-7efada0 elementor-section-full_width elementor-section-height-min-height elementor-section-height-default elementor-section-items-middle rt-parallax-bg-no executive-section"
        data-id="7efada0"
                    ...
                    <div class="elementor-element elementor-element-3475d2f elementor-widget elementor-widget-heading"
                        ...
                        <div class="elementor-widget-container">
                            <h1 class="elementor-heading-title elementor-size-default">
                                {{ \App\Models\Setting::getVal('executive_body_title', 'National Executive Body') }}
                            </h1>
                        </div>
    ...
    <section class="premium-wing-section">
        <div class="container mb-5 text-center">
            <h2 class="font-weight-bold" style="color: #e36108; font-size: 32px; margin-bottom: 0;">
                राष्ट्रीय कार्यकारिणी निकाय (National Executive Body)
            </h2>
